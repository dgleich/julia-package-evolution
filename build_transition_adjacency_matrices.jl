...
"""
Build sparse adjacency matrices for each month handling the transition between
METADATA.jl and General registry, using the appropriate data source for each time period.
...
# Main function
function main()
    println("Starting transition-aware adjacency matrix generation...")
    ...
    matrices_dir = "matrices_transition"
    ...
    for month in months
        ...
        try
            ...
            A, edge_count = build_adjacency_matrix(file_path, package_to_index)
